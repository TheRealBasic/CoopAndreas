...
| W2 | `RYDER` | Mission Sync Pod (Ryder stream) | `done` (2026-03-31) | `clear` (0 missing on 2026-03-31) | `C1..C6` complete; mission rows promoted to `done` after checklist closure (`docs/qa/storyline-mission-signoff-checklist.md`) and evidence in `docs/qa/storyline-wave-mission-evidence.md` (W2 table). |
| W3 | `SMOKE` | Mission Sync Pod (Smoke stream) | `done` (2026-03-31) | `clear` (0 missing on 2026-03-31) | `C1..C6` complete; `OG Loc` + `Wrong Side Of The Tracks` promoted with reconnect/late-join parity evidence and checklist closure (`docs/qa/storyline-mission-signoff-checklist.md`). |
...
| Home Invasion | `RYDER` | Mission Sync Pod (Ryder stream) | 2026-03-31 | `done` |
| Catalyst | `RYDER` | Mission Sync Pod (Ryder stream) | 2026-03-31 | `done` |
| Robbing Uncle Sam | `RYDER` | Mission Sync Pod (Ryder stream) | 2026-03-31 | `done` |
| OG Loc | `SMOKE` | Mission Sync Pod (Smoke stream) | 2026-03-31 | `done` |
...
| --- | --- | --- | --- | --- |
| OG Loc | `done` (2026-03-31) | Mission Sync Pod (Smoke stream) | `task_follow_nav_mesh_to_coord`, `task_bike_flee_point`, `set_objective` | Promoted after all parity gates passed in `docs/qa/storyline-wave-mission-evidence.md` and checklist completion in `docs/qa/storyline-mission-signoff-checklist.md`. |
| Wrong Side Of The Tracks | `done` (2026-03-31) | Mission Sync Pod (Smoke stream) | `create_train`, `task_drive_by`, `task_car_mission` + reconnect hydration proof | Promoted after all parity gates passed in `docs/qa/storyline-wave-mission-evidence.md` and checklist completion in `docs/qa/storyline-mission-signoff-checklist.md`. |
...
| Burning Desire | `scm/scripts/CRASH.txt` | `done` (2026-03-31; checklist: `docs/qa/storyline-mission-signoff-checklist.md`) | Owner: Mission Sync Pod (CRASH stream). Dependency opcodes: `create_fire`, `remove_char_from_car_maintain_position`, `set_char_obj_leave_car` (verified via `COMMAND_TASK_LEAVE_CAR` / `COMMAND_TASK_LEAVE_ANY_CAR` sync paths). Blockers `BD-BLK-01..03` closed with fire lifecycle replay and terminal once-only parity evidence. | All parity gates `pass` in `docs/qa/storyline-wave-mission-evidence.md` (WC row, `NET-WC-2026-03-31-A`) with reconnect + late-join restoration proof and shared hardening reuse (`WB-FIX-001..WB-FIX-004`). |
| Gray Imports | `scm/scripts/CRASH.txt` | `done` (2026-03-31; checklist: `docs/qa/storyline-mission-signoff-checklist.md`) | Owner: Mission Sync Pod (CRASH stream). Dependency opcodes: `create_actor`, `set_char_obj_kill_char_any_means`, `blow_up_car`. Blockers `GI-BLK-01..03` closed with actor authority + detonation transition parity evidence. | All parity gates `pass` in `docs/qa/storyline-wave-mission-evidence.md` (WC row, `NET-WC-2026-03-31-B`) with reconnect + late-join hydration proof and shared hardening reuse (`WB-FIX-001..WB-FIX-004`). |
| Home Invasion | `scm/scripts/RYDER.txt` | `done` (2026-03-31; checklist: `docs/qa/storyline-mission-signoff-checklist.md`) | Owner: Mission Sync Pod (Ryder stream). Dependency opcodes: `create_pickup`, `task_go_straight_to_coord`, `set_timers`. Previous blockers `HIN-BLK-01..03` closed via objective/fail/pass/reconnect parity validation. | All six gates `pass` in `docs/qa/storyline-wave-mission-evidence.md` (W2 row, `NET-W2-2026-03-31-D`); reconnect/late-join replay stability validated with `WB-FIX-001..WB-FIX-004`. |
| Catalyst | `scm/scripts/RYDER.txt` | `done` (2026-03-31; checklist: `docs/qa/storyline-mission-signoff-checklist.md`) | Owner: Mission Sync Pod (Ryder stream). Dependency opcodes: `create_train`, `task_jump_from_car`, `set_mission_audio_position`. Previous blockers `CAT-BLK-01..03` closed with train authority, jump transition, and mission-audio parity validation. | All six gates `pass` in `docs/qa/storyline-wave-mission-evidence.md` (W2 row, `NET-W2-2026-03-31-E`); reconnect/late-join replay stability validated with `WB-FIX-001..WB-FIX-004`. |
| Robbing Uncle Sam | `scm/scripts/RYDER.txt` | `done` (2026-03-31; checklist: `docs/qa/storyline-mission-signoff-checklist.md`) | Owner: Mission Sync Pod (Ryder stream). Dependency opcodes: `create_object`, `attach_object_to_car`, `set_char_obj_kill_char_any_means`. Previous blockers `RUS-BLK-01..03` closed with crate lifecycle and attach-state parity validation. | All six gates `pass` in `docs/qa/storyline-wave-mission-evidence.md` (W2 row, `NET-W2-2026-03-31-F`); reconnect/late-join replay stability validated with `WB-FIX-001..WB-FIX-004`. |
| OG Loc | `scm/scripts/SMOKE.txt` | `done` (2026-03-31; checklist: `docs/qa/storyline-mission-signoff-checklist.md`) | Owner: Mission Sync Pod (Smoke stream). Dependency opcodes: `task_follow_nav_mesh_to_coord`, `task_bike_flee_point`, `set_objective`. Blockers `OGL-BLK-01..03` closed with nav-mesh, bike-flee, and objective fan-out parity validation. | All six gates `pass` in `docs/qa/storyline-wave-mission-evidence.md` (W3 row, `NET-W3-2026-03-31-A`); reconnect/late-join replay stability validated with shared hardening guards. |
...
| Wrong Side Of The Tracks | `scm/scripts/SMOKE.txt` | `done` (2026-03-31; checklist: `docs/qa/storyline-mission-signoff-checklist.md`) | Owner: Mission Sync Pod (Smoke stream). Dependency opcodes: `create_train`, `task_drive_by`, `task_car_mission`. Blockers `WST-BLK-01..03` closed with train authority, drive-by sequence parity, and reconnect hydration validation. | All six gates `pass` in `docs/qa/storyline-wave-mission-evidence.md` (W3 row, `NET-W3-2026-03-31-B`); reconnect/late-join replay stability validated before promotion. |
