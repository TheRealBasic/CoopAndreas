...
public:
	...
	static void PlayerJetpackTransition__Handle(void* data, int size);
	...
	static void VehicleTrailerLinkSync__Handle(void* data, int size);
	...
	static void PlayerSniperAimMarkerState__Handle(void* data, int size);
	...
	static void FireCreate__Handle(void* data, int size);
	static void FireUpdate__Handle(void* data, int size);
	static void FireRemove__Handle(void* data, int size);
